...
let ulValues = new Array ("POČETNA", "O NAMA","PROJEKTI", "CENOVNIK","KONTAKT");
...
for(let i =0;i<listaFooterMrezeValues.length;i++){
    listaFooterMreze+=`<li><a href="#" id="${listaFooterMrezeId[i]}">${listaFooterMrezeValues[i]}</a></li>`;
}
...
let footerListaLinkovi = new Array("#1","#2","#3","#4","#5","https://aleksandar1021.github.io/portfolio/");
let footerLista ="";
...
let ddlGradovi = new Array("Beograd","Mladenovac","lazarevac","Obrenovac","Novi Sad", "Bujanovac","Zrenjanin","Priština","Kragujevac","Kruševac","subotica","Aranđelovac","Pirot","negotin","valjevo","Aleksandrovac","Petrovac na Mlavi");
...
function obradaForme(){
    ...
    let greskaSelect = false;
        ...
        if(!regIzrazImePrezime.test(objIme.value)){
            ...
            objIme.nextElementSibling.innerHTML = "Ime i prezime moraju da sadrže minimum po 3 karaktera, sa razmakom između, primer:<br/>Aleksandar Kandić";
